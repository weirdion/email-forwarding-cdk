...
import { BOUNCE_DOMAIN_LIST, BOUNCE_EMAIL_SENDER, EMAIL_MAP, RECIPIENT_DOMAIN_LIST } from './env-config';
...
export class EmailForwardingCdkStack extends Stack {
  constructor(scope: Construct, id: string, props?: StackProps) {
    ...
    const powertoolsLayer = LayerVersion.fromLayerVersionArn(this,
      'LambdaPowertools',
      `arn:aws:lambda:${this.region}:017000801446:layer:AWSLambdaPowertoolsPython:latest`
    );
